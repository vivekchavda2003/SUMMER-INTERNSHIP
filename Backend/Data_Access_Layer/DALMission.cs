...
using Data_Access_Layer.Helper;
...
namespace Data_Access_Layer
{
    public class DALMission
    {
        ...
        public async Task<string> AddMission(Missions mission)
        {
            ...
            try
            {
                mission.StartDate = mission.StartDate.ToUtc();
                mission.EndDate = mission.EndDate.ToUtc();
                mission.RegistrationDeadLine = mission.RegistrationDeadLine.ToUtc();
                mission.CreatedDate = DateTime.Now.ToUtc();
                mission.ModifiedDate = DateTime.Now.ToUtc();
            ...
            try
            {
                ...
                if (!missionExists)
                {
                    ...
                    if (missionToUpdate != null)
                    {
                        ...
                        missionToUpdate.StartDate = mission.StartDate.ToUtc();
                        missionToUpdate.EndDate = mission.EndDate.ToUtc();
                        missionToUpdate.MissionType = mission.MissionType;
                        missionToUpdate.TotalSheets = mission.TotalSheets;
                        missionToUpdate.RegistrationDeadLine = mission.RegistrationDeadLine.ToUtc();
                        ...
                        missionToUpdate.ModifiedDate = DateTime.Now.ToUtc();
